...
function convert_assy_file_to_contigs(url, auth, auth_cb, timeout, async_job_check_time_ms, async_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.convert = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax("convert_assy_file_to_contigs.convert",
